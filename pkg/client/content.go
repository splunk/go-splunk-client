...
// Content is an empty data type that provides the conten
// method to satisfy the contenter interface. It is the prescribed means
// of having a struct properly adhere to the Contenter type.
//
// Example:
