...
// SetNamespace sets User and App to the values given. It returns an error
// if the Namespace is invalid after these values are set.
func (c *Namespace) SetNamespace(user string, app string) error {
	c.User = user
	c.App = app
